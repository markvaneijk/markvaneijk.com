...
@section('main')
    <div class="md:py-20">
        <h2 class="mb-3 text-4xl font-bold leading-tight">👋🏼<br>I'm <x-link href="https://x.com/markvaneijk">Mark.</x-link></h2>
        <p class="mb-6 text-2xl leading-relaxed">
            I'm a Laravel Developer from <x-link href="https://nijmegen.nl">🇳🇱&nbsp;Nijmegen</x-link>.<br>
            <x-link href="https://github.com/markvaneijk">🧑🏻‍💻&nbsp;Full-Stack Maker of Webs,</x-link>
            <x-link href="https://ux.nl">entrepeneur,</x-link>
            <x-link href="{{ route('posts') }}">tinkerer</x-link> and
            <x-link href="{{ route('now') }}">currently working</x-link>
            on <x-link href="https://rocketee.rs">🚀&nbsp;Rocketeers</x-link>.
        </p>
        <p class="mb-6 text-2xl leading-relaxed">
