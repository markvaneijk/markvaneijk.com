@if($nowPlaying?->item && $nowPlaying?->item?->type == 'track')
    <a href="{{ $nowPlaying->item->external_urls->spotify }}" target="_blank" class="hover:brightness-[1.25] shadow transition hover:shadow-2xl ease-in-out duration-[1000ms] block bg-[#24d44e] p-4 rounded text-black">
